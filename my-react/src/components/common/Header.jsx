        ...
        <header className="bg-white py-4 text-black sticky z-50 shadow-md top-0 left-0 w-full">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="account flex items-center gap-5">
                    ...
                    <button className="bg-blue-500  text-white px-6 py-3 rounded mr-4 cursor-pointer transition-all hover:scale-110 hover:text-cyan-500"onClick={handleLoginClick}>SignUp</button>{" "}
